...
MacBook Pro (planned): will replicate Node.js, Python + pyodbc + ODBC Driver 18, and git credentials so that local web dev and DB exploration work outside ThreatLocker. This section will be expanded with the Mac's specific paths when it is set up.
